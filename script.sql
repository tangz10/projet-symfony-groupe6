...
-- Hash du mot de passe: $2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu
INSERT INTO participant (id, site_id, email, roles, password, nom, prenom, telephone, administrateur, actif) VALUES
    (1, 1, 'mathis.delahais2024@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Delahais', 'Mathis', '0612345678', 0, 1),
    (2, 1, 'johann.degennes2024@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Degennes', 'Johann', '0623456789', 0, 1),
    (3, 2, 'landrygabriel960@gmail.com', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Landry', 'Gabriel', '0634567890', 0, 1),
    (4, 3, 'sophie.martin@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Martin', 'Sophie', '0645678901', 0, 1),
    (5, 1, 'lucas.bernard@campus-eni.fr', '["ROLE_ADMIN"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Bernard', 'Lucas', '0656789012', 1, 1),
    (6, 2, 'emma.dubois@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Dubois', 'Emma', '0667890123', 0, 1),
    (7, 4, 'thomas.leroy@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Leroy', 'Thomas', '0678901234', 0, 1),
    (8, 5, 'julie.moreau@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Moreau', 'Julie', '0689012345', 0, 1),
    (9, 6, 'alexandre.petit@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Petit', 'Alexandre', '0690123456', 0, 1),
    (10, 7, 'marie.garcia@campus-eni.fr', '["ROLE_USER"]', '$2y$13$vXwtm/kogYnKBanA7ob0ouZVdlBmgeKnYcAWUrBfklW8Jn.Cybffu', 'Garcia', 'Marie', '0601234567', 0, 1);
